				...
				<div className='w-full flex flex-col md:flex-row justify-evenly items-center md:items-start gap-6'>
					...
					<div className='max-w-lg flex flex-col gap-4'>
						...
						<p className='font-lexendDeca text-sm md:text-base font-light'>
							...
							erat, vel porttitor erat. In odio mi, interdum vel rutrum ut, scelerisque vitae massa. Nam ut tincidunt
							dolor, sed consequat arcu. Integer in dui ac purus rutrum consectetur. Vestibulum a nisi non tellus
							tristique sodales non in lacus.{' '}
						</p>
					</div>
				</div>
