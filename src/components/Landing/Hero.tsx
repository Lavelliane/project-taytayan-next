...
const Hero = () => {
	return (
		<section
			className='h-screen translate-y-16 w-full flex bg-gradient-to-r from-blue-300 via-indigo-300 to-purple-300 justify-center'
					...
					<div className='w-full h-full flex flex-col'>
						<div className='flex flex-col gap-2 mt-20 sm:mt-0 mb-24 sm:mb-12 md:mb-28'>
							<div className='text-5xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-lexendDeca flex flex-col'>
								<span className='text-[#1e3888] font-semibold flex-none z-10'>Learn Today,</span>
						...
						<div className='flex gap-6 pl-1 sm:pl-2 md:hidden'>
							<Button className='w-fit bg-tertiary border-none text-white text-lg px-1 z-10' size='sm' href='#benefits'>
								Find out more
								<svg
							...
							<Button className='w-fit bg-white border-none text-black px-1 z-10' size='sm' href='#'>
								Be a partner
							</Button>
						</div>
						<div className='gap-6 pl-1 sm:pl-2 hidden md:flex'>
							<Button className='w-fit bg-tertiary border-none text-white text-lg px-1 z-10' size='lg' href='#benefits'>
								Find out more
								<svg
									className='-mr-1 ml-2 h-4 w-4'
									fill='currentColor'
							...
							<Button className='w-fit bg-white border-none text-black px-1 z-10' size='lg' href='#'>
								Be a partner
							</Button>
						</div>
					</div>
					<div className='w-full h-full pt-24 sm:pt-0 z-10 hidden sm:block'>
						<Image src={flavorImage} alt='flavor-image' width={2000} style={{ objectFit: 'fill', height: 'auto' }} />
					</div>
				</div>
			</div>
