        ...
        <div className='col-span-1 lg:col-span-3 max-h-[285px]'>
            <div className='flex h-full bg-gradient-to-b from-blue-500 via-indigo-500 to-purple-500 rounded-2xl justify-center lg:justify-between overflow-hidden'>
                <div className='flex flex-col p-6 justify-between'>
                    ...
                    <div className='w-fit sm:mb-20'><TaytayanLogoText /></div>
                    <Button color='warning' size='sm' className='bg-orange-400 px-3 w-auto lg:w-fit' href='/myevents'>
                        <svg className="w-4 h-4 mr-3 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
