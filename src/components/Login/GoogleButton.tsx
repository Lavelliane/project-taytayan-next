...
export const GoogleButton = () => {
  ...
  const updateUserState = useAuthStore((state) => state.updateUserState)
    ...
    <div>
      <Button 
        ...
        <div className='flex items-center'>
            ...
            <span className='font-roboto font-normal pl-[10px] text-md sm:text-lg text-black'>{isSigningIn ? "Signing you in..." : "Continue with Google"}</span>
        </div>
      </Button>
    </div>
  )
