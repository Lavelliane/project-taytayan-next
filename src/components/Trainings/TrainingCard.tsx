  ...
  return (
    <Card className="max-w-full p-0 shadow-none border-[1px] md:border-[3px] justify-between" theme={cardTheme}>
      <div className='flex items-center'>
        <Avatar img="/institution.svg" alt="avatar" rounded size='md' color='purple' theme={avatarTheme} bordered className='justify-start min-w-10 mr-2' />
        <h1 className='text-sm lg:text-lg font-bold'>
          {trainingName}
        </h1>
      </div>
      <h3 className='mt-2 mb-4 lg:mt-0 lg:mb-0'><CategoryBadge category={trainingCategory} /></h3>
      <h5 className='flex gap-3 items-center'>
        <svg className="min-w-4 w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
      ...
      <h5 className='flex gap-3 items-center'>
        <svg className="min-w-4 w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 21">
          <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
            <path d="M8 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
            <path d="M13.8 12.938h-.01a7 7 0 1 0-11.465.144h-.016l.141.17c.1.128.2.252.3.372L8 20l5.13-6.248c.193-.209.373-.429.54-.66l.13-.154Z" />
          </g>
        </svg>
        <span className='font-base text-xs lg:text-sm'>{trainingAddress}</span>
      </h5>
      <h5 className='flex gap-3 items-center'>
        <svg className="min-w-4 w-4 h-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
