...
const trainingCategories = [
	{
		key: 1,
		value: 'Technical',
		className: 'bg-gradient-to-r from-violet-400 to-purple-500 text-white border-purple-400',
	},
	...
	{ key: 3, value: 'Personal', className: 'bg-gradient-to-r from-lime-400 to-green-400 text-white border-lime-500' },
	{
		key: 4,
		value: 'Professional',
		className: 'bg-gradient-to-r from-amber-300 to-yellow-400 text-white border-yellow-400',
	},
	{
		key: 5,
		value: 'Vocational & Arts',
		className: 'bg-gradient-to-r from-pink-400 to-red-400 text-white border-red-400',
	},
