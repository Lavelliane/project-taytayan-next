...
const cardTheme: CustomFlowbiteTheme["card"] = {
  root: {
    children:
      "flex h-full flex-col justify-between gap-2 lg:gap-3 xl:gap-4 p-6",
  },
};
  ...
  return (
    ...
    >
      ...
      <h5 className="flex gap-3 items-center">
        ...
        <span className="font-base text-xs lg:text-sm">{eventAddress.formattedAddress || "Project Taytayan HQ" }</span>
      </h5>
      <h5 className="flex gap-3 items-center">
        <svg
          className="min-w-4 w-4 h-4 text-gray-800 dark:text-white"
