...
const TrainingsCard = () => {
    ...
    return <Card className="max-w-2xl w-[30%] h-fit mr-auto">
        <div className="flex gap-2 items-center">
            <Image src={CertificateIcon} alt="certification icon" width={0} height={0} style={{ width: 60, height: 'auto' }} />
            <h5 className="text-sm text-gray-900 dark:text-gray-400 font-semibold">
                {certName}
            </h5>
        </div>
        <h5 className="rounded-full bg-[#7895FF] text-white text-xs font-semibold px-4 py-2 w-fit">{typeOfCertification}</h5>
        <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-4 items-start">
                <svg className="w-[16px] h-[16px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 21">
