	...
	return (
		<>
			<button
				...
				type='button'
				className='inline-flex items-center py-2 px-4 mt-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600'
			>
					...
					<div className='h-full'>
						<ul className='flex flex-col gap-2 font-medium'>
							...
							<li>
								<Link
									href='/jobs'
									className={`flex items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg ${pathName.includes('/jobs') ? 'bg-[#E3F6F5] dark:bg-[#E3F6F5] text-[#0090D8] dark:text-[#0090D8]' : 'text-gray-700 dark:text-white'}`}
								>
									<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
							...
							<li>
								<Link
									href='/trainings'
									className={`flex items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg ${pathName.includes('/trainings') ? 'bg-[#E3F6F5] dark:bg-[#E3F6F5] text-[#0090D8] dark:text-[#0090D8]' : 'text-gray-700 dark:text-white'}`}
								>
							...
							<li>
								<Link
									href='/network'
									className={`flex items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg ${pathName.includes('/network') ? 'bg-[#E3F6F5] dark:bg-[#E3F6F5] text-[#0090D8] dark:text-[#0090D8]' : 'text-gray-700 dark:text-white'}`}
								>
									<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
										<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 1v4a1 1 0 0 1-1 1H1m4 10v-2m3 2v-6m3 6v-4m4-10v16a.97.97 0 0 1-.933 1H1.933A.97.97 0 0 1 1 18V5.828a2 2 0 0 1 .586-1.414l2.828-2.828A2 2 0 0 1 5.828 1h8.239A.97.97 0 0 1 15 2Z" />
									</svg>
							...
							<li>
								<Link
									href='/contact-us'
									className={`flex items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg ${pathName.includes('/contact-us') ? 'bg-[#E3F6F5] dark:bg-[#E3F6F5] text-[#0090D8] dark:text-[#0090D8]' : 'text-gray-700 dark:text-white'}`}
								>
									<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
					...
					<div className='flex flex-col h-3/4 justify-between'>
						...
						<ul className='flex flex-col gap-2 h-fit font-medium'>
							<li>
								<Link
									href='#settings'
									className={`flex items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg ${pathName.includes('/settings') ? 'bg-[#E3F6F5] dark:bg-[#E3F6F5] text-[#0090D8] dark:text-[#0090D8]' : 'text-gray-700 dark:text-white'}`}
								>
									<svg className="w-4 h-4 text-[#1A56DB] dark:text-[#1A56DB]" aria-hidden="true" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
